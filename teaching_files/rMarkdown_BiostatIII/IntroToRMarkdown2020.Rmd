...
<https://fogelstrom.github.io/IntroToRMarkdown_BiostatIII_2020/>
...
Installing `tidyverse` will install both RMarkdown and tinytex. Tidyverse is very useful for data management.]
...
.small[Works for .html and .pdf documents. Does not work for making .docx documents
...
I use it a lot for making tables for word documents. Did not work well in this .htlm presentation. 
...
2. Make your own short report on a subject of your choice (or try to replicate the 'ExampleReport'). Try to include as much formatting as possible:  

  * edit the YAML metadata  
  * headers 
  * <b>bold</b>, <i>italics</i>, lists
  * inline code  
  * figures from data (plot variables in `iris` dataset)  
...
4. Render your report to the format of your choice  
